...
function writeCodexRuleMirrors(cwd, templatesDir) {
  ...
  // 与 Cursor/Claude 的 rules 模板同源；落盘到 f2s-rules，避免占用官方 .codex/rules
  const names = fs
