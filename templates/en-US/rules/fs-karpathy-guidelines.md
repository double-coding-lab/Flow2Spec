---
description: Karpathy-style coding behavior guidelines: clarify assumptions first, implement minimally, change only what is necessary, and execute against verifiable goals. Coexists with fs-* rules; process hard constraints defer to fs.
alwaysApply: true
---

# Karpathy-Style Coding Behavior Guidelines

> Runs **in parallel** with the project's flow-spec / `fs-*` rules. If any item conflicts with a mandatory fs step, **fs and project conventions take precedence**.
